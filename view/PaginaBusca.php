...
<head>
  ...
  <link rel="stylesheet" href="/TCC_Qualifica-o_Guilherme_Caio-master/externo/BuscaScreen.css">
</head>
...
<body>
  <div class="container-fluid px-5">
    ...
    <div id="sidebar" class="sidebar">
      <ul>
        <li><a href="index.php?acao=gerar">Gerar ATA</a></li>
        <li><a href="index.php?acao=buscar">Buscar ATA</a></li>
      </ul>
    </div>
  ...
  <!-- jQuery -->
  <script src="/TCC_Qualifica-o_Guilherme_Caio-master/js/jquery-3.7.1.min.js"></script>
  
  <!-- JS para menu -->
  <script src="/TCC_Qualifica-o_Guilherme_Caio-master/js/menu.js"></script>
