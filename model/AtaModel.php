    ...
    public function criarAta($organizacoes, $cursos, $nucleos, $cargos, $integrantes, $locais)
    {
        ...
        if ($_SERVER["REQUEST_METHOD"] === "POST") {
            ...
            foreach ($integrantes as $i) {
                $listIntegrantes = array_merge($listIntegrantes, $integr->getIntegrantes($i, null));
            }
            ...
            foreach ($listIntegrantes as $i) {
                echo $i["cargo_sigla"] . ". " . $i["nome"] . " ______________________";
            }
            ...
            $pdf->Write(0, $nucleo["nome"] . " - " . $nucleo["sigla"]);
            $pdf->Ln(6);
            $pdf->Write(0, $curso["nome"]);
            $pdf->Ln(6);
            $pdf->Write(0, $organizacao["sigla"] . "|" . $organizacao["nome"]);
            $pdf->Ln(12);
            ...
            foreach ($listIntegrantes as $integ) {
                $pdf->Write(0, $integ["cargo_sigla"] . ". " . $integ["nome"] . " ______________________");
                $pdf->Ln(6);
            }
